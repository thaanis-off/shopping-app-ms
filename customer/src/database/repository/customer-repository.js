...
class CustomerRepository {
  ...
  async AddWishlistItem(customerId,{_id, name, description, banner, available, price }) {
    ...
    try {
      console.log("touched addWishListItem function inside the repository/customer-repositry.js")
      ...
      console.log("The error inside the AddWishListItem function" ,err)
      throw new APIError(
        "API Error",
        STATUS_CODES.INTERNAL_ERROR,
